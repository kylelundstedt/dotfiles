...
| `rss-feed`            | **200** (`RSS Feed Service`)   | Healthy public Go service. System unit `srv.service` is enabled with restart policy; healthcheck timer is active. **Rebuilt 2026-07-28** on `ghcr.io/kylelundstedt/exeslim` — 268M used vs 7.8G before; proxy re-set to public after recreate. |
