...
- [ ] **Migrate LLM gateway onto an AC appliance VM** — plan approved 2026-07-21, all decisions confirmed: phases + gates in [agent_docs/llm-gateway-migration.md](agent_docs/llm-gateway-migration.md) (rationale in [agent_docs/llm-gateway.md](agent_docs/llm-gateway.md); build pattern in [agent_docs/apple-container-vms.md](agent_docs/apple-container-vms.md)). Next action: Phase 0 host gates
