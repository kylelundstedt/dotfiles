...
| `launchd/`        | LaunchAgents for macOS — scheduled jobs: repo sync, msgvault (2am), Tigris backup (4am) (stowed) |
...
| `msgvault-sync.sh`| Nightly Messages/email archive sync — klundstedt-mini only (2am)                                 |
| `tigris-backup.sh`| Nightly encrypted backup of home + external data to Tigris — klundstedt-mini only (4am)          |
